...
const DashboardFilters = () => {
  ...
  {
    /* <form className="max-w-sm mx-auto  ">
    <select id="countries" className="border lg:w-32 md:w-28 sm:w-28 p-2 w-28 border-gray-300  text-sm rounded-2xl focus:ring-blue-500 focus:border-blue-500 block p-1 bg-white text-black ">
